package com.tsa.ecommerce.storage;
...
public class PrefrenceManager {
    ...
    private PrefrenceManager(Context mCtx) {
        this.mCtx = mCtx;
    }


    public static synchronized PrefrenceManager getInstance(Context mCtx) {
        if (mInstance == null) {
            mInstance = new PrefrenceManager(mCtx);
        }
        return mInstance;
    }
